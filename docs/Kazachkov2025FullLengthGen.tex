...
\begin{document}
	...
	\section{Abstract}
		...
		В данной работе мы представляем архитектуру \textit{BoLID} - решение для интеграции данных всего тела, позволяющее достигать более точной персонализации по сравнению с методами, учитывающими лишь лицо.
